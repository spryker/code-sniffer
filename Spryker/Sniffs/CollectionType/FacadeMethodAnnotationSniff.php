...
/**
 * Spryker CollectionType classes should have a getFacade() annotation.
 */
class FacadeMethodAnnotationSniff extends AbstractCollectionTypeMethodAnnotationSniff
{
    /**
     * @inheritdoc
     */
