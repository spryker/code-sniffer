...
/**
 * Spryker CollectionType classes should have a getFactory() annotation.
 */
class FactoryMethodAnnotationSniff extends AbstractCollectionTypeMethodAnnotationSniff
{
    /**
     * @inheritdoc
     */
