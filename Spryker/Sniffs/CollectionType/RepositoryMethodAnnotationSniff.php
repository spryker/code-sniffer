...
/**
 * Spryker CollectionType classes should have a getRepository() annotation.
 */
class RepositoryMethodAnnotationSniff extends AbstractCollectionTypeMethodAnnotationSniff
{
