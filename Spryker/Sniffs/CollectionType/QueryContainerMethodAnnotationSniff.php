...
/**
 * Spryker CollectionType classes should have a getQueryContainer() annotation.
 */
class QueryContainerMethodAnnotationSniff extends AbstractCollectionTypeMethodAnnotationSniff
{
