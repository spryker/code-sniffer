...
/**
 * Verifies that self:: is used inside the own class for self reference.
 *
...
class SelfAccessorSniff extends AbstractSprykerSniff
{
     ...
     * @return void
     */
    protected function checkSelf(File $phpcsFile, int $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    protected function checkNew(File $phpcsFile, int $i, string $name)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    protected function fixNameToSelf(File $phpcsFile, int $index, string $name)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    protected function checkDoubleColon(File $phpcsFile, int $i, string $name)
    {
        $tokens = $phpcsFile->getTokens();
