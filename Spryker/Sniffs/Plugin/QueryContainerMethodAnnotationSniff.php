...
/**
 * Spryker Plugin classes should have a getQueryContainer() annotation.
 */
class QueryContainerMethodAnnotationSniff extends AbstractPluginMethodAnnotationSniff
{
